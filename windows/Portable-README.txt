...
2. Launch "ChatGPT To Codex.exe" from the extracted folder. The first cold-boot window is intentionally a read-only log console; normal controls live in the tray, dashboard, and Settings surfaces.
